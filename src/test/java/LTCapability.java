...
public class LTCapability {
    ...
    public static Object[] getDefaultTestCapability() {
        ...
        ltOptions1.addProperty("build", "Playwright JUnit Build");
        ...
        capabilities2.addProperty("browserName", "Chrome"); // Browsers allowed: `Chrome`, `MicrosoftEdge`,
                                                                   // `pw-chromium`, `pw-firefox` and `pw-webkit`
        ...
        ltOptions2.addProperty("build", "Playwright JUnit Build");
